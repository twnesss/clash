...
var (
	...
	baseURL       string = "https://github.com/twnesss/clash/releases/download/Prerelease-Alpha/mihomo"
	versionURL    string = "https://github.com/twnesss/clash/releases/download/Prerelease-Alpha/version.txt"
	packageURL    string
...
func init() {
	...
	if !strings.HasPrefix(C.Version, "alpha") {
		baseURL = "https://github.com/twnesss/clash/releases/latest/download/mihomo"
		versionURL = "https://github.com/twnesss/clash/releases/latest/download/version.txt"
	}
}
